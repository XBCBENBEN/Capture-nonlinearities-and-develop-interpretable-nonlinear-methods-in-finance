...
model_linear2 <- lm(RET. ~ log_scope_1+LOGSIZE_t.1+Winsorised.BM_t.1+Winsorised.Leverage_t.1+Winsorised.INVESTA_t.1+Winsorised.ROE_t.1+LOGPPE_t.1+MOM_duplicate_t.1+beta_t.1+VOLAT_t.1+Winsorised.SALESGR_t.1+EPSGR_t.1, data = Data)
...
interaction_forest_2 = interactionfor(
  RET. ~ log_scope_1+LOGSIZE_t.1+Winsorised.BM_t.1+Winsorised.Leverage_t.1+Winsorised.INVESTA_t.1+Winsorised.ROE_t.1+LOGPPE_t.1+MOM_duplicate_t.1+beta_t.1+VOLAT_t.1+Winsorised.SALESGR_t.1+EPSGR_t.1,
  data = Data,
  num.trees = 2000,
  importance = 'both',
...
interaction_forest_22 = interactionfor(
  RET. ~ log_scope_1+VOLAT_t.1_Winsorised.SALESGR_t.1+MOM_duplicate_t.1_VOLAT_t.1+beta_t.1_VOLAT_t.1+MOM_duplicate_t.1_VOLAT_t.1+LOGSIZE_t.1+Winsorised.BM_t.1+Winsorised.Leverage_t.1+Winsorised.INVESTA_t.1+Winsorised.ROE_t.1+LOGPPE_t.1+MOM_duplicate_t.1+beta_t.1+VOLAT_t.1+Winsorised.SALESGR_t.1+EPSGR_t.1,
  data = Data,
  num.trees = 2000,
  importance = 'both',
  simplify.large.n = TRUE,
...
# Perform linear regression
model_linear22 <- lm(RET. ~ log_scope_1+VOLAT_t.1_Winsorised.SALESGR_t.1+MOM_duplicate_t.1_VOLAT_t.1+beta_t.1_VOLAT_t.1+MOM_duplicate_t.1_VOLAT_t.1+LOGSIZE_t.1+Winsorised.BM_t.1+Winsorised.Leverage_t.1+Winsorised.INVESTA_t.1+Winsorised.ROE_t.1+LOGPPE_t.1+MOM_duplicate_t.1+beta_t.1+VOLAT_t.1+Winsorised.SALESGR_t.1+EPSGR_t.1, data = Data)
